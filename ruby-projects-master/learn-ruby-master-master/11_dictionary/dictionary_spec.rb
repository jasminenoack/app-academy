...
#changed be_false/be_true because of error "expected false to respond to false" I checked documentation and found these were changed to 'be_truthy' to check for a value that is technically a true value or 'be true' to check for the exact value true. 
